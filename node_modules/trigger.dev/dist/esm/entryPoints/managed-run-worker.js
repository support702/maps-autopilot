...
const standardInputStreamManager = new StandardInputStreamManager(apiClientManager.clientOrThrow(), getEnvVar("TRIGGER_STREAM_URL", getEnvVar("TRIGGER_API_URL")) ?? "https://api.trigger.dev", (getEnvVar("TRIGGER_STREAMS_DEBUG") === "1" || getEnvVar("TRIGGER_STREAMS_DEBUG") === "true") ??
    false);
...
async function doBootstrap() {
    return await runTimelineMetrics.measureMetric("trigger.dev/start", "bootstrap", {}, async () => {
        ...
        const tracingSDK = new TracingSDK({
            ...
            hostMetrics: true,
            hostMetricGroups: getEnvVar("TRIGGER_SYSTEM_METRICS_ENABLED") === "1"
                ? undefined
...
//# sourceMappingURL=managed-run-worker.js.map