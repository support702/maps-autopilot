...
function getOutputOptions({ imageTag, push, load, compression, compressionLevel, forceCompression, }) {
    // Always use OCI media types for compatibility
    const outputOptions = ["type=image", "oci-mediatypes=true", "rewrite-timestamp=true"];
    if (imageTag) {
