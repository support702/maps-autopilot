...
export function configureTriggerTaskCommand(program) {
    return program
        .command("trigger")
...
export async function triggerTaskCommand(taskName, options) {
...
export async function triggerTask(taskName, options) {
    if (!taskName) {
