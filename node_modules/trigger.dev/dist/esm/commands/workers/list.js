...
export function configureWorkersListCommand(program) {
...
async function workersListCommand(dir, options) {
    return await wrapCommandAction("workerListCommand", WorkersListCommandOptions, options, async (opts) => {
        return await _workersListCommand(dir, opts);
    });
}
async function _workersListCommand(dir, options) {
    ...
    logger.table(workers.data.map((worker) => ({
