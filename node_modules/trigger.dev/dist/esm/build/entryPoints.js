...
import { devEntryPoints, managedEntryPoints, telemetryEntryPoint, unmanagedEntryPoints, } from "./packageModules.js";
...
export async function createEntryPointManager(dirs, config, target, watch, onEntryPointsChange) {
    ...
    if (watch && onEntryPointsChange) {
        ...
        // Handle file changes
        const updateEntryPoints = async (event, path) => {
            ...
            const hasChanged = newEntryPoints.length !== currentEntryPoints.length ||
