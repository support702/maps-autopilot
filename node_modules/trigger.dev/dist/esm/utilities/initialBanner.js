...
import { DEFFAULT_PROFILE, readAuthConfigCurrentProfileName, readAuthConfigProfile, } from "./configFiles.js";
...
export async function printInitialBanner(performUpdateCheck = true, profile) {
...
export async function printStandloneInitialBanner(performUpdateCheck = true, profile) {
    const profileInfo = getProfileInfo(profile);
