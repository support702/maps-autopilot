...
export declare const listOrgsTool: {
    name: string;
    title: string;
    description: string;
    inputSchema: {};
    handler: (input: unknown, { ctx }: ToolMeta) => Promise<CallToolResult>;
};
...
export declare const createProjectInOrgTool: {
    name: string;
    title: string;
    description: string;
    inputSchema: {
        orgParam: import("zod").ZodString;
