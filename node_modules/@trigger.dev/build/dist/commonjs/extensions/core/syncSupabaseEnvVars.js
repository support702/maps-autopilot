...
exports.SUPABASE_ENV_VARS = void 0;
exports.syncSupabaseEnvVars = syncSupabaseEnvVars;
...
function syncSupabaseEnvVars(options) {
    const sync = (0, core_js_1.syncEnvVars)(async (ctx) => {
        ...
        const outputEnvVars = exports.SUPABASE_ENV_VARS;
        ...
        const [branchesFetchError, branchesResponse] = await (0, v3_1.tryCatch)(fetch(branchesUrl, { headers }));
        ...
        const [branchesParseError, branches] = await (0, v3_1.tryCatch)(branchesResponse.json());
        ...
        const [detailFetchError, branchDetailResponse] = await (0, v3_1.tryCatch)(fetch(branchDetailUrl, { headers }));
        if (detailFetchError) {
        ...
        const [detailParseError, branchDetail] = await (0, v3_1.tryCatch)(branchDetailResponse.json());
        if (detailParseError) {
        ...
        const [apiKeysFetchError, apiKeysResponse] = await (0, v3_1.tryCatch)(fetch(apiKeysUrl, { headers }));
        let anonKey;
        let serviceRoleKey;
        if (apiKeysFetchError) {
            ...
            const [apiKeysParseError, apiKeys] = await (0, v3_1.tryCatch)(apiKeysResponse.json());
