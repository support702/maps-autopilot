...
export interface Task<TIdentifier extends string, TInput = void, TOutput = any> {
     ...
     */
    batchTrigger: (items: Array<BatchItem<TInput>> | AsyncIterable<BatchItem<TInput>> | ReadableStream<BatchItem<TInput>>, options?: BatchTriggerOptions, requestOptions?: TriggerApiRequestOptions) => Promise<BatchRunHandle<TIdentifier, TInput, TOutput>>;
    /**
     ...
     * ```
     */
    batchTriggerAndWait: (items: Array<BatchTriggerAndWaitItem<TInput>> | AsyncIterable<BatchTriggerAndWaitItem<TInput>> | ReadableStream<BatchTriggerAndWaitItem<TInput>>, options?: BatchTriggerAndWaitOptions) => Promise<BatchResult<TIdentifier, TOutput>>;
}
