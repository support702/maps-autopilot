...
export const GetOrgsResponseBody = z.array(z.object({
    id: z.string(),
    title: z.string(),
    slug: z.string(),
    createdAt: z.coerce.date(),
...
export const InitializeDeploymentRequestBody = InitializeDeploymentRequestBodyFull.transform((data) => {
...
export const RetrieveRunTraceSpan = RetrieveRunTraceSpanSchema.extend({
