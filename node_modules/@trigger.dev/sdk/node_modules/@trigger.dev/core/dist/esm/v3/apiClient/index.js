...
import { ApiDeploymentListResponseItem, AppendToStreamResponseBody, BatchTaskRunExecutionResult, BatchTriggerTaskV3Response, CanceledRunResponse, CompleteWaitpointTokenResponseBody, CreateBatchResponse, CreateInputStreamWaitpointResponseBody, CreateStreamResponseBody, CreateUploadPayloadUrlResponseBody, CreateWaitpointTokenResponseBody, DeletedScheduleObject, EnvironmentVariableResponseBody, EnvironmentVariableWithSecret, ListRunResponseItem, QueueItem, QueryExecuteResponseBody, ReplayRunResponse, ResetIdempotencyKeyResponse, RetrieveBatchV2Response, RetrieveRunResponse, RetrieveRunTraceResponseBody, ScheduleObject, SendInputStreamResponseBody, StreamBatchItemsResponse, TaskRunExecutionResult, TriggerTaskResponse, UpdateMetadataResponseBody, WaitForDurationResponseBody, WaitForWaitpointTokenResponseBody, WaitpointRetrieveTokenResponse, WaitpointTokenItem, } from "../schemas/index.js";
...
export class ApiClient {
    ...
    async sendInputStream(runId, streamId, data, requestOptions) {
        return zodfetch(SendInputStreamResponseBody, `${this.baseUrl}/realtime/v1/streams/${runId}/input/${streamId}`, {
            method: "POST",
            headers: this.#getHeaders(false),
    ...
    async createInputStreamWaitpoint(runFriendlyId, body, requestOptions) {
        return zodfetch(CreateInputStreamWaitpointResponseBody, `${this.baseUrl}/api/v1/runs/${runFriendlyId}/input-streams/wait`, {
            method: "POST",
            headers: this.#getHeaders(false),
            body: JSON.stringify(body),
        }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
    ...
    async executeQuery(query, options, requestOptions) {
        ...
        return zodfetch(QueryExecuteResponseBody, `${this.baseUrl}/api/v1/query`, {
            method: "POST",
            headers: this.#getHeaders(false),
            body: JSON.stringify(body),
        }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
