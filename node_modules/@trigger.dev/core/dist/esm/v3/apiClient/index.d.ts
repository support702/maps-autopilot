...
import { AnyRealtimeRun, AnyRunShape, RealtimeRun, RunShape, RunStreamCallback, RunSubscription, SSEStreamSubscription, TaskRunShape, RealtimeRunSkipColumns, type SSEStreamPart } from "./runStream.js";
...
export declare class ApiClient {
    ...
    retrieveRunTrace(runId: string, requestOptions?: ZodFetchOptions): ApiPromise<{
        trace: {
            ...
            rootSpan: {
                ...
                children: Array<import("../schemas/api.js").RetrieveRunTraceSpan>;
            };
        };
    }>;
    ...
    sendInputStream(runId: string, streamId: string, data: unknown, requestOptions?: ZodFetchOptions): Promise<{
        ok: boolean;
    }>;
    createInputStreamWaitpoint(runFriendlyId: string, body: CreateInputStreamWaitpointRequestBody, requestOptions?: ZodFetchOptions): Promise<{
        isCached: boolean;
        waitpointId: string;
    }>;
