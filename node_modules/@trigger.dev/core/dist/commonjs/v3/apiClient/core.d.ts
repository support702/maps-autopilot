...
export declare function zodfetch<TResponseBodySchema extends z.ZodTypeAny>(schema: TResponseBodySchema, url: string, requestInit?: RequestInit, options?: ZodFetchOptions<z.output<TResponseBodySchema>>): ApiPromise<z.output<TResponseBodySchema>>;
...
export type ZodFetchSSEMessageValueSchema<TDiscriminatedUnion extends z.ZodDiscriminatedUnion<any, any>> = z.ZodFirstPartySchemaTypes | TDiscriminatedUnion;
...
export declare function wrapZodFetch<T extends z.ZodTypeAny>(schema: T, url: string, requestInit?: RequestInit, options?: ZodFetchOptions<z.output<T>>): Promise<ApiResult<z.infer<T>>>;
export {};
